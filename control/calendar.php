...
$ym = $_POST['year_month'];
if ($ym != ""){
$normal= `find $PATH_VIDEO -type f|grep "$ym"|awk -F"$ym" '{print $2}'|awk -F"/" '{print $1}'|tr "\n" "|"`;
$intru = `find $PATH_VIDEO -type f|grep "$ym"|grep "/INTRU/"|awk -F"$ym" '{print $2}'|awk -F"/" '{print $1}'|tr "\n" "|"`;
$power = `find $PATH_VIDEO -type f|grep "$ym"|grep "/POWER/"|awk -F"$ym" '{print $2}'|awk -F"/" '{print $1}'|tr "\n" "|"`;
