...
'&mo_time=' + encodeURIComponent(document.getElementsByName('mo_time')[0].value) +
'&tu_time=' + encodeURIComponent(document.getElementsByName('tu_time')[0].value) +
'&we_time=' + encodeURIComponent(document.getElementsByName('we_time')[0].value) +
'&th_time=' + encodeURIComponent(document.getElementsByName('th_time')[0].value) +
'&fr_time=' + encodeURIComponent(document.getElementsByName('fr_time')[0].value) +
'&sa_time=' + encodeURIComponent(document.getElementsByName('sa_time')[0].value) +
'&su_time=' + encodeURIComponent(document.getElementsByName('su_time')[0].value) +
